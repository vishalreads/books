...
let md = `# BKRS Source Structural Mapping: *Bhagat Singh: A Life in Revolution* (2022)
...
fs.writeFileSync(path.join(__dirname, '..', 'docs', 'distillations', 'bhagat-singh-a-life-in-revolution', 'SOURCE_STRUCTURE.md'), md, 'utf8');
console.log('Successfully generated docs/distillations/bhagat-singh-a-life-in-revolution/SOURCE_STRUCTURE.md');
